...
<div class="row" id="customer_login">
	...
	<div class="medium-6 columns">
		...
		<div class="login panel callout clearfix">
		...
		<form method="post" class="login">
			...
			<div class="row collapse">
				...
				<div class="small-5 columns">
					<p><a charset="lost-password" href="<?php echo esc_url( wc_lostpassword_url() ); ?>"><?php _e( 'Lost your password?', 'woocommerce' ); ?></a></p>
				</div>
			</div>
	...
	<div class="medium-6 columns">
		...
		<div class="register panel callout">
