...
if (!class_exists('WooChimp')) {
    ...
    class WooChimp
    {
        ...
        public function __construct()
        {
            ...
            // Catch mc_cid (MailChimp Campaign ID)
        ...
        public function options_validate($input)
        {
            ...
            if ($current_tab == 'checkout') {
                ...
                // Checkbox position
                $output['woochimp_checkbox_position'] = (in_array($input['woochimp_checkbox_position'], array('woocommerce_checkout_before_customer_details', 'woocommerce_checkout_after_customer_details', 'woocommerce_before_checkout_form', 'woocommerce_after_checkout_form', 'woocommerce_checkout_billing', 'woocommerce_checkout_shipping', 'woocommerce_checkout_order_review'))) ? $input['woochimp_checkbox_position'] : 'woocommerce_checkout_after_customer_details';
        ...
        public function on_completed($order_id)
        {
            ...
            if (class_exists('WC_Order') && $this->load_mailchimp()) {
                ...
                // Check if we have campaign ID for this user/order
        ...
        {
            // Firstly - move mc_cid cookie if exists to order data
                ...
                foreach ($this->opt['sets'] as $set) {
                    ...
                    if ($proceed_subscription) {
                        ...
                        foreach ($set['fields'] as $custom_field) {
                            if (preg_match('/^order_/', $custom_field['name'])) {
        ...
        public function track_campaign()
        {
            ...
            setcookie('woochimp_mc_cid', $_GET['mc_cid'], time()+7776000);
        }
