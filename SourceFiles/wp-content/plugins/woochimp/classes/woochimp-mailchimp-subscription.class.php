...
class WooChimp_MailChimp_Signup extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        // Submit button
        $form .= '</tr><tr><td><button type="button" id="woochimp_widget_subscription_submit" value="'. $this->options['woochimp_label_button'] .'">'. $this->options['woochimp_label_button'] .'</button></td>';
