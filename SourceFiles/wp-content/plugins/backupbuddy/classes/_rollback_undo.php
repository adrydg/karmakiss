...
if ( ! isset( $_GET['confirm'] ) || ( '1' != $_GET['confirm'] ) ) { // Do rollback since user confirmed.
	...
	echo '<br><br>';
	echo 'If you do not want to undo the rollback you may safely delete this file, ' . basename( __FILE__ ) . '.';
	die();
}
...
echo '<h3>Database Rollback Cancelled</h3>';
echo 'The rollback procedure was successfully cancelled. Your site should now function as before the rollback was initiated.';
