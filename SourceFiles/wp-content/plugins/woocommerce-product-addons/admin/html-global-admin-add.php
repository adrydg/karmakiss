	...
	<form method="POST" action="">
		<table class="form-table global-addons-form">
			...
			<tr>
				...
				<td>
					<select id="addon-objects" name="addon-objects[]" multiple="multiple" style="width:50%;" data-placeholder="<?php _e('Choose some options&hellip;', 'woocommerce-product-addons'); ?>" class="chosen_select">
