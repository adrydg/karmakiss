	...
	private function get_product_category_fields_html( $points = '', $max_discount = '' ) {
		...
		?>
			<tr class="formfield">
				...
				<td>
					<input type="number" size="5" name="_wc_points_earned" value="<?php echo esc_attr( $points ); ?>" step="any" min="0" placeholder="<?php _e( 'Category Points Earned', 'wc_points_rewards' ); ?>" />
